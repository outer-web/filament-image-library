...
return [
    ...
    'forms' => [
        ...
        'placeholders' => [
            ...
            'search' => 'Buscar por nome do arquivo ou texto alternativo...',
        ],
        'prefixes' => [
            'width' => 'Largura',
            'height' => 'Altura',
    ...
    'notifications' => [
        'delete' => [
            ...
            'failure' => 'Falha ao excluir imagem.',
        ],
        'upload' => [
        ...
        'edit_source_image' => [
            'success' => 'Imagem de origem atualizada com sucesso.',
            'failure' => 'Falha ao atualizar imagem de origem.',
        ],
    ],
    'page' => [
        'empty_state' => [
