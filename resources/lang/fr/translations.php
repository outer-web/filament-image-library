...
return [
    'actions' => [
        'bulk_selection_actions' => 'Actions de Sélection',
    ...
    'notifications' => [
        ...
        'upload' => [
            'success' => '{1} Image téléchargée avec succès.|[2,*] Images téléchargées avec succès.',
            'failure' => '{1} Échec du téléchargement de l\'image fournie.|[2,*] Échec du téléchargement des images fournies.',
        ],
        'edit_source_image' => [
